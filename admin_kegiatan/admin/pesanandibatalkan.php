...
$sepeda = data("SELECT * FROM pembeli WHERE id_admin=$id_admin && status='waktuhabis' LIMIT $awaldata, $jumlahdataperhalaman");
...
<div class="pull-right">
  <a href="?page=pesanandibatalkan" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-refresh"></i></a>
