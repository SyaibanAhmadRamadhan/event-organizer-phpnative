    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">PHP Intermediate</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Pada kelas PHP Intermediate ini, kamu akan mendalami materi lanjutan dari kelas PHP Dasar. PHP Intermediate banyak membahas topik-topik penting yang pastinya akan bisa langsung diimplementasikan pada proyek aplikasi kamu.</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/php.png" class="#" alt="">
        </div>
      </div>
    </div>
