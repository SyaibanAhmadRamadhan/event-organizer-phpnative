    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Desain Grafis Mastery</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Apakah kamu ingin berpindah karir menjadi Desainer Grafis dan memulai dari awal hingga mahir? Apakah kamu ingin menjadi Desainer Grafis yang siap kerja? Apakah kamu seorang Desainer Grafis yang ingin menambah skills? Kelas ini cocok untuk kamu!</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/desain.png" class="#" alt="">
        </div>
      </div>
    </div>
